...
This document preserves the detailed project information, containing the research questions, methods, datasets, metrics, workflow, sanity results, and guidance for interpreting full results.
